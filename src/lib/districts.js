...
export const DISTRICTS = {
  ...
  離島: {
    ...
    金門縣: ['金城鎮','金湖鎮','烈嶼鄉','金沙鎮','山內鄉','烏坵鄉'],
    連江縣: ['連江鄉','東引鄉','西引鄉'],
  },
}

// 所有縣市列表（flat）
export const ALL_CITIES = Object.values(DISTRICTS).flatMap(r => Object.keys(r))

// 依縣市取得行政區
export function getDistricts(city) {
  for (const region of Object.values(DISTRICTS)) {
